...
assert { profile_data.user.emails[0] == "john@example.com" }
...
pub comprehensive_user = user(id: "1").{name, emails, age, posts.{title, createdAt}}

assert { comprehensive_user.name == "John Doe" }
assert { comprehensive_user.emails[0] == "john@example.com" }
...
assert { deep_selection.user.emails[0] == "john@example.com" }
...
pub user_overview = user(id: "1").{name, emails}
...
assert { user_overview.emails[0] == "john@example.com" }
...
assert { complex_query.users[0].emails[0] == "john@example.com" }
assert { complex_query.users[1].name == "Jane Smith" }
assert { complex_query.users[1].emails[0] == "jane@example.com" }

...
> Meta: the scripting core — what someone from JS/Go/Python already knows, with
> Dang's flavor. Each chapter should read in one sitting; call out the
> surprises, keep the familiar parts terse.
